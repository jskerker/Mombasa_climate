% Updated in October 2020 to correct the rounding from the histcounts
% function. This function should be used in lieu of the original version.
% In the main SDP code, set climParam.checkBins = true.
function [T_Temp_abs, T_Precip_abs, T_Temp_delta, T_Precip_delta, T_over_time, P_over_time] ...
    = bma2TransMat_v2( NUT, NUP, s_T, s_P, N, climParam)
