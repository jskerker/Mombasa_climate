...
if ~isempty(getenv('SLURM_JOB_ID'))
    ...
    projpath = '/Users/jenniferskerker/Documents/GradSchool/Research/Project1/Code/Models/Mombasa_climate';
end
...
runParam.shortageLoadName = 'shortage_costs_01_Dec_2020_19_31_36';
...
M_C = length(s_C);
storage = [x(1) x(2)]; % small dam, large dam capacity in MCM
...
if runParam.calcTmat
    load('/Users/jenniferskerker/Documents/GradSchool/Research/Project1/Code/Models/Mombasa_climate/BMA_code/BMA_results_RCP45_2020-11-10.mat')
    [T_Temp, T_Precip, ~, ~, ~, ~] = bma2TransMat( NUT, NUP, s_T, s_P, N, climParam);
    save('T_Temp_Precip_RCP45B', 'T_Temp', 'T_Precip')    
else
...
if runParam.saveOn
    ...
    disp(stateMsg);
    cd('/Volumes/Ultra Touch/FlexDamProject/Results/RCP45-DamOpt-ga-Jan18');
    savename_results = strcat('results_', setPathway, jobid,'_', datetime);
...
load('/Users/jenniferskerker/Documents/GradSchool/Research/Project1/Code/Models/Mombasa_climate/BMA_code/BMA_results_RCP45_2020-11-10.mat', 'MUT', 'MUP')
